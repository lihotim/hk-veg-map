...
NOTICE_TEXT = '''
    更新至2023年11月4日。「素食類型」如果查不到資料一律當「蛋奶素」，請自行向店家查詢。大部分資料來自Google及OpenRice，如有任何錯漏敬請見諒。   
    --- By Tim ---
'''

USER_GUIDE = '''
    使用方法：
    1. 點選【香港地區】。按綠色按鈕內的「X」可以移除該地區；按右邊的灰色「X」可以移除所有地區。按選擇欄任何位置可以選擇個別香港地區。
    2. 點選【地區】。按綠色按鈕內的「X」可以移除該地區；按右邊的灰色「X」可以移除所有地區。按選擇欄任何位置可以選擇個別地區。
    3. 表格會顯示合乎選擇條件的【餐廳名單】。
    4. 【素食地圖】會顯示所有合乎選擇條件餐廳的座標（綠色氣球）。點擊座標可以顯示該餐廳的詳細資料，以及是Openrice連結。
    5. 由於Google提供的【座標】未必完全準確，座標位置跟餐廳的實際位置可能會有幾個舖位的出入，請自行用地址確認餐廳位置。祝您用餐愉快！
'''
